...
const Lessons = () => {
  ...
  const lessons = [
    ...
    },
    {
      ...
      locked: false,
      rating: 4.9,
      description: 'Master French pronunciation with audio examples'
    },
    {
      id: 3,
      title: 'German Grammar: Articles',
      language: 'German',
      level: 'Intermediate',
      duration: '25 min',
      completed: false,
      locked: false,
      rating: 4.7,
      description: 'Understanding der, die, das and German articles'
    },
    {
      id: 4,
      ...
      locked: false,
      rating: 4.6,
      description: 'Practice real-world Italian conversations'
    },
    {
      id: 5,
      ...
      locked: true,
      rating: 4.9,
      description: 'Advanced Kanji characters and meanings'
    }
  ];

  const levels = ['all', 'Beginner', 'Intermediate', 'Advanced'];
  const languages = ['all', 'Spanish', 'French', 'German', 'Italian', 'Japanese'];
