...
import { User, Mail, Calendar, Award, TrendingUp, Settings, Edit3 } from 'lucide-react';
...
const Profile = () => {
  ...
  const achievements = [
    { title: 'First Lesson', description: 'Completed your first lesson', earned: true },
    { title: 'Week Streak', description: '7 days of continuous learning', earned: true },
    { title: 'Grammar Master', description: 'Scored 100% on grammar quiz', earned: true },
    { title: 'Conversation Pro', description: '50 chat sessions completed', earned: false },
    { title: 'Polyglot', description: 'Learning 3+ languages', earned: false }
  ];

  const learningStats = [
    { label: 'Total Study Time', value: '48 hours', icon: TrendingUp },
    { label: 'Lessons Completed', value: '24', icon: Award },
    { label: 'Current Streak', value: '7 days', icon: Calendar },
    { label: 'Languages Learning', value: '2', icon: User }
  ];
