...
const Dashboard = () => {
  ...
  const stats = [
    { icon: BookOpen, label: 'Lessons Completed', value: '24', color: 'bg-blue-500' },
    { icon: Clock, label: 'Study Time', value: '48h', color: 'bg-green-500' },
    { icon: Award, label: 'Achievements', value: '12', color: 'bg-purple-500' },
    { icon: Target, label: 'Current Streak', value: '7 days', color: 'bg-orange-500' }
  ];

  const recentLessons = [
    { title: 'Spanish Basics', progress: 85, level: 'Beginner' },
    { title: 'French Pronunciation', progress: 60, level: 'Intermediate' },
    { title: 'German Grammar', progress: 40, level: 'Advanced' }
  ];

  const upcomingLessons = [
    { title: 'Italian Conversation', time: '2:00 PM', date: 'Today' },
    { title: 'Japanese Writing', time: '10:00 AM', date: 'Tomorrow' },
    { title: 'Portuguese Listening', time: '3:30 PM', date: 'Wed' }
  ];
          ...
          >
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-white">{user?.progress}%</span>
              </div>
